...
from opt import conv_block, identity_block
...
x = AveragePooling2D((7, 7), name='avg_pool')(x_b)

x = Flatten()(x)
logits = Dense(num_classes, name='fc1000')(x)
probabilities = Activation('softmax')(logits)
resnet50 = models.Model(inputs=input_img, outputs=probabilities)
resnet50.summary()
